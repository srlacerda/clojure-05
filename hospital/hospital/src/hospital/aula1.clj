...
(defn adiciona-paciente
  ...
  (if-let [id (:id paciente)]
        ...
        (throw (ex-info "Paciente não possui possui id" {:paciente paciente}))))
...
(defn imprimi-relatorio-de-paciente [visitas, paciente]
  (println "Visistas do paciente" paciente "são" (get visitas paciente)))
...
(defn testa-uso-de-pacientes []
  (let [guilherme {:id 15, :nome "Guilherme"}
    ...
    ;
    (imprimi-relatorio-de-paciente visitas daniela)
    ;(imprimi-relatorio-de-paciente visitas 20)
